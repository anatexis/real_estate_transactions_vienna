...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--output",
        type=str,
        help="""path to output file folder, if you use this no
    ...
    parser.add_argument(
        ...
        "--KG",
        type=int,
        help="""KG code, enter without the leading 0, (use -l to get a list of
                                                        all KG codes)
    ...
    parser.add_argument(
        ...
        "--address",
        type=str,
        help="""Enter (part of) an address to filter the dataframe
    ...
    parser.add_argument(
        ...
        "--list",
        action="store_true",
        help="""Prints a list of all KG codes to the screen or to a
                                                                  file if -o is used""",
    )
    ...
    parser.add_argument(
        ...
        "--rows",
        type=int,
        help="""how many rows should be shown (= will be printed on your
    ...
    parser.add_argument(
        ...
        nargs="+",
        action="append",
        help="Correlation between two columns",
    )
